...
app.post("/reset", (req, res) => {
  db = {
    jogadores: [],        // limpa todos os jogadores
    partidas: [],         // limpa todas as partidas
    fila: [],             // limpa a fila
    ultimoIdJogador: 0,   // zera contagem de jogadores
    ultimoIdPartida: 0,   // zera contagem de partidas
    vitoriasConsecutivas: 0,
    ultimoVencedor: null,
  };

  res.json({ success: true, message: "Campeonato e jogadores resetados" });
});
